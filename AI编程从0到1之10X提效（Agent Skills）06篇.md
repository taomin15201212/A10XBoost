...
![聊天式使用 AI 与 Agent Skills 系统化交付的差异对比图](illustrations/agent-skills/01-comparison-chat-vs-skills-system.png)
...
![最小可用 Skill 的四要素框架图](illustrations/agent-skills/02-framework-skill-mvp-design.png)
...
![7 天做出第一套 Agent Skills 的执行时间线](illustrations/agent-skills/03-timeline-7day-skill-rollout.png)
...
![Agent Skills 三大常见误区与修正对比图](illustrations/agent-skills/04-comparison-3-pitfalls-fixes.png)
