...
```mermaid
graph TD
    A["(根) AI编程从0到1之10X提效"] --> B["01 IDE编辑器"]
    A --> C["02 LLM编码模型"]
    A --> D["03 CLI终端工具"]
    A --> E["04 Extensions/Plugins扩展插件"]
    A --> F["05-A Agents智能体"]
    A --> G["05-B AI工作流编排"]
    A --> H["06 Agent Skills技能"]
    A --> I["07 MCP协议"]
    A --> J["08 Vibe Design"]
    A --> K["09 Vibe Build"]
    A --> L["10 Serverless API"]

    click B "./AI编程从0到1之10X提效（AI IDE编辑器 ）01篇.md" "查看 IDE 编辑器篇章"
    click C "./AI编程从0到1之10X提效（AI LLM厂商及模型 ）02篇.md" "查看 LLM 模型篇章"
    click D "./AI编程从0到1之10X提效（AI 终端 ）03篇.md" "查看 CLI 终端工具篇章"
    click E "./AI编程从0到1之10X提效（AI Extensions Plugins 扩展插件 ）04篇.md" "查看扩展插件篇章"
    click F "./AI编程从0到1之10X提效（AI Agents 智能体 ）05-A 篇.md" "查看 Agents 智能体篇章"
    click G "./AI编程从0到1之10X提效（AI 工作流编排）05-B 篇.md" "查看 AI 工作流编排篇章"
    click H "./AI编程从0到1之10X提效（Agent Skills）06篇.md" "查看 Agent Skills 技能篇章"
    click I "./AI编程从0到1之10X提效（Mcp 协议）07篇.md" "查看 MCP 协议篇章"
    click J "./AI编程从0到1之10X提效（Vibe Design 氛围式设计 ）08篇.md" "查看 Vibe Design 篇章"
    click K "./AI编程从0到1之10X提效（Vibe Coding 氛围式编码 ）09篇.md" "查看 Vibe Coding 篇章"
    click L "./AI编程从0到1之10X提效（Serverless API  服务接口 ）10篇.md" "查看 Serverless API 篇章"
```
...
### 内容生成
- 所有文章采用 Markdown 格式
- 插图使用 PNG/WebP 格式，存放在对应 illustrations 目录
- 引用来源需标注时间锚点

### 内容更新
- 更新文章时同步更新本 CLAUDE.md 的变更记录
- 新增模块需补充到模块索引表格
- 插图更新需保留源文件和 prompts
