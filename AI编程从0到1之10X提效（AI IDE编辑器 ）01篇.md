...
![AI IDE 工具生态分层与适配场景图](illustrations/ai-ide-10x/01-infographic-ai-ide-landscape.png)
...
![AI IDE 选型四约束决策框架图](illustrations/ai-ide-10x/02-framework-selection-constraints.png)

---

## 把效率做上去的关键：形成一个“少返工”的闭环

![AI 编程少返工闭环流程图](illustrations/ai-ide-10x/03-flowchart-low-rework-loop.png)
...
![多模型任务分工与能力映射对照图](illustrations/ai-ide-10x/04-comparison-model-role-mapping.png)
