...
- GitHub Changelog（2026-02-04）：Claude and Codex public preview  
...
- GitHub Changelog（2025-12-18）：Copilot Agent Skills  
  https://github.blog/changelog/2025-12-18-github-copilot-now-supports-agent-skills
- VS Code Updates 1.109（Release date: 2026-02-04）  
  https://code.visualstudio.com/updates
- VS Code Insiders 1.110（Last updated: 2026-02-11）  
  https://code.visualstudio.com/updates/v1_110
- VS Code Security（Copilot/Agent 安全边界）  
...
- VS Code Extension Runtime Security（Publisher Trust）  
  https://code.visualstudio.com/docs/configure/extensions/extension-runtime-security
- VS Code Private Marketplace（2025-11-18）  
  https://code.visualstudio.com/blogs/2025/11/18/PrivateMarketplace
- JetBrains AI Assistant Product Versions  
  https://www.jetbrains.com/help/ai-assistant/product-versions.html
- X Search: augmentcode  
  https://x.com/search?f=top&q=augmentcode&src=typed_query
- X Search: cline coding  
  https://x.com/search?f=top&q=cline+coding&src=typed_query
- X Search: roo code  
  https://x.com/search?f=top&q=%22roo+code%22&src=typed_query
- Roo Code profile（mobile）  
  https://mobile.x.com/roo_code/with_replies
- X Search: Kiro IDE  
  https://x.com/search?f=top&q=Kiro+IDE&src=typed_query
- X Trending: Kiro + Claude Code  
  https://x.com/i/trending/1945687496165339189
- X Trending: Kiro vs Claude Code (Amazon internal discussion)  
  https://x.com/i/trending/2022282454346703088
